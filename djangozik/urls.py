...
from djangolib.urls import urlpatterns as urlslib
...
urlpatterns = (patterns('',
                       ...
                       url(r'^api/',
                           include('api.urls')),
                       url(r'^tab/$',
                           login_required(GuitarTabsView.as_view()),
                           name="tab"),
                       url(r'^favicon\.',
